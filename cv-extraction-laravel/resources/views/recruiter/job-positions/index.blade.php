                            ...
                            <div class="flex items-center">
                                ...
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" @click.away="open = false" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10" style="display: none;">
                                        <div class="py-1">
                                            <a href="{{ route('recruiter.job-positions.show', $jobPosition) }}" class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                            ...
                                            <a href="{{ route('recruiter.job-positions.edit', $jobPosition) }}" class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                                <svg class="mr-3 h-5 w-5 text-green-500 group-hover:text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                </svg>
                                                Edit Position
                                            </a>
                                            <form action="{{ route('recruiter.job-positions.toggle-active', $jobPosition) }}" method="POST" class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 w-full">
                                                @csrf
                                                @method('PATCH')
