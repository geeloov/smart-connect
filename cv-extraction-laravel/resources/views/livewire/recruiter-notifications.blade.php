    ...
    x-data="{
        ...
        init() {
            ...
            setTimeout(() => {
                ...
                if (sessionStorage.getItem('recruiter-notifications-initialized') !== 'true') {
                    this.previousCount = {{ $unreadCount }};
                    sessionStorage.setItem('recruiter-notifications-initialized', 'true');
                    sessionStorage.setItem('recruiter-notifications-open', 'false');
                } else {
                    // Restore previous state
                    this.open = sessionStorage.getItem('recruiter-notifications-open') === 'true';
                    this.previousCount = {{ $unreadCount }};
                }
        ...
        toggleOpen() {
            ...
            this.open = !this.open;
            sessionStorage.setItem('recruiter-notifications-open', this.open);
        }
    }"
    wire:poll.30s
    x-cloak>
