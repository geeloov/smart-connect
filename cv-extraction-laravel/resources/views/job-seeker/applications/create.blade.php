                            ...
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                ...
                                <div class="inline-flex flex-wrap gap-2 mt-4 md:mt-0">
                                    <div class="inline-flex items-center px-3 py-1 rounded-lg text-sm font-medium bg-[#B9FF66]/30 text-[#191A23] border border-[#191A23]/50">
                                        <div class="flex-shrink-0 h-5 w-5 rounded-full bg-[#B9FF66] flex items-center justify-center mr-1.5">
                                    ...
                                    <div class="inline-flex items-center px-3 py-1 rounded-lg text-sm font-medium bg-[#B9FF66]/30 text-[#191A23] border border-[#191A23]/50">
                                        <div class="flex-shrink-0 h-5 w-5 rounded-full bg-[#B9FF66] flex items-center justify-center mr-1.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-[#191A23]" fill="none" viewBox="0 0 24 24" stroke="#191A23">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('checkCompatibilityBtn').addEventListener('click', function() {
            ...
            fetch(`/job-seeker/resume-content/${defaultCvId}`, {
                headers: {
